...
/*    public void Maj($Personnage P, Action A, List<Joueur> J){
        ...
        if(P instanceof Gentil){
            ...
            else if(A.get_Action() == Actions.FrapperE.getValeur()){ //Frapper � l'est 
                Coordonnees v = new Coordonnees();
            ...
            else if(A.get_Action() == Actions.FrapperO.getValeur()){ //Frapper � l'ouest
                Coordonnees v = new Coordonnees();
                v.setX(P.getPosition().getX()-1);
                v.setY(P.getPosition().getY());
                $Personnage E1=null;
