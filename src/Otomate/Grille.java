...
//Retourne la case de coordonnees c
    ...
    /**
     * Fonction permettant de frapper � un emplacement al�atoire s'il y a des entit�s � proximit�
     */
    ...
    public void Maj($Personnage P, Action A, List<Joueur> J){
        ...
        if(P instanceof Gentil){
            if(A.get_Action() == 0)                  //indifférent
                ...
                if(N.estChemin()){
                    P.deplacementHaut();
                    Description = "Se d�place au Nord.";
                } else {
                    Description = "Tente de se d�placer au Nord mais �choue.";
                }
                return;
            }
                ...
                if(S.estChemin()) {
                    P.deplacementBas();
                    Description = "Se d�place au Sud.";
                } else {
                    Description = "Tente de se d�placer au Sud mais �choue.";
                }
                return;
            }
                ...
                if(E.estChemin()) {
                    P.deplacementDroite();
                    Description = "Se d�place � l'Est.";
                } else {
                    Description = "Tente de se d�placer � l'Est mais �choue.";
                }
                return;
            }
                ...
                if(O.estChemin()) {
                    P.deplacementGauche();
                    Description = "Se d�place � l'Ouest.";
                } else {
                    Description = "Tente de se d�placer � l'Ouest mais �choue.";
                }
                return;
            }
                ...
                if(C.estRamassable()){
                    ...
                    Description = "Tente de ramasser " + Contenus.fromint(C.getValeur()).toString() + "mais �choue.";
                }
            }
